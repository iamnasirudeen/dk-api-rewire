/* eslint quotes: 0 */
// Validation definitions for validateSchema hook for service `emailConfirmation`. (Can be re-generated.)
...
let base = merge(
  ...
  // !<DEFAULT> code: base
  {
    ...
    description: "EmailConfirmation database.",
    required: ["key", "email", "username"],
    uniqueItemProperties: ["key", "email", "username"],
    properties: {
      status: {
        type: "boolean",
        enum: [true, false]
