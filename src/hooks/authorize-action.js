...
module.exports = function(options = {}) {
  ...
  return async context => {
    const modelName = context.service.Model.modelName;
    // Using camel-case, feathers-plus generator uses it to generate model names
    const subjectName = _.camelCase(modelName);
    const capitalizedPath = capitalize.words(
      changeCase.sentenceCase(modelName)
    );
